    ...
    .action(async () => {
      try {
        ...
        try {
          ...
          logger.info('    $ cf-registrar list');
          logger.info('');
          logger.info('  View a domain\'s registrant info:');
          logger.info('    $ cf-registrar list --filter example.com');
          logger.info('');
          logger.info('  Create a contact template (save time on updates):');
          logger.info('    $ cf-registrar template save personal');
          logger.info('');
          logger.info('  Update a domain registrant:');
          logger.info('    $ cf-registrar update example.com --template personal');
          logger.info('');
          logger.info('  Bulk update multiple domains:');
          logger.info('    $ cf-registrar bulk-update --domains domains.txt --template personal');
          logger.info('');
          logger.info('Get help anytime:');
          logger.info('  $ cf-registrar --help');
          logger.info('  $ cf-registrar <command> --help');
          logger.info('');
          logger.info('═'.repeat(70));
          logger.blank();
        } catch (error) {
          if (error instanceof AuthenticationError) {
            ...
            logger.info('  $ cf-registrar login');
            logger.info('');
            logger.info('Option B: Use manual setup');
            logger.info('  $ cf-registrar config init');
            logger.info('');
